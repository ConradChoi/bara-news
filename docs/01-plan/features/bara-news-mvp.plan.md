...
| 관점 | 내용 |
|------|------|
| **문제** | 교육·문화예술 분야의 신뢰할 수 있는 전문 미디어가 부재하고, 관련 종사자·시민·기관이 분산된 정보 속에서 양질의 콘텐츠를 찾기 어려움 |
| **솔루션** | 주식회사 일리아(ylia.io)가 AI 팀으로 운영하는 교육·문화예술 특화 온라인 신문 바라뉴스(bara-new.kr) |
| **기능 UX 효과** | Google Drive CMS로 비개발자도 즉시 기사 발행, 구독 신청 폼으로 독자 DB 자동 확보 |
| **핵심 가치** | "바라(히브리어: 소망·기대)" — 교육·문화예술 저널리즘으로 사회적 소망을 전달하는 미디어 플랫폼 |
...
| 독자 그룹 | 설명 |
|-----------|------|
| 교육·문화예술 종사자 | 교사, 예술가, 문화기획자 등 업계 종사자 |
| 일반 시민 | 교육·문화 이슈에 관심 있는 30~50대 성인 |
| 관련 기관·단체 | 교육청, 문화재단, 학교, 연구기관 등 |
...
components/
├── layout/
│   ├── Header.tsx        → 바라뉴스 로고 + 네비게이션 (홈/교육/문화예술)
...
│
├── filter/
│   └── CategoryFilter.tsx → 전체 / 교육 / 문화예술 탭
│
└── subscribe/
